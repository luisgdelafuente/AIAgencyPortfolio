...
export default function BlogSection() {
  ...
  const { data: pageContent, isLoading: isContentLoading } = useQuery<PageContent>({
  ...
  const isLoading = isBlogLoading || isContentLoading;
  
  // Only render if we have section content after loading
  if (!isLoading && (!content.blogTitle && !content.blogSubtitle)) {
    return null;
  }
