...
export default function Footer() {
  return (
    <footer className="bg-gray-50 border-t border-gray-100 pt-16 pb-6">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/projects" className="text-gray-600 text-sm hover:text-gray-900">Projects</Link></li>
              <li><Link href="/contact" className="text-gray-600 text-sm hover:text-gray-900">Contact</Link></li>
