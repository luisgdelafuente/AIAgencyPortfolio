        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 lg:gap-16 mb-14">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-5 mt-6">
              <a href="https://github.com/luisgdelafuente" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transition-colors">
              ...
              <a href="https://www.linkedin.com/company/hal149com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
